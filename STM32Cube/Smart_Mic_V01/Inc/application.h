...
extern __IO uint32_t Dac2_Reg;

#define ADC_BUFFER_SIZE (256*12) // maximum preallocated buffer size

#ifdef WIRELESS
#define PACKET_SIZE (256*2) // Packet size to send out bytes
#else
#define PACKET_SIZE (256*24) // Packet size to send out bytes
#endif

#define SIG_THRESH 2500// Range: 4095/2 <-> 4095 (mid range 4095/2)
#define THRESH_KEEP_ON 1000 // timeout on threshold detection
